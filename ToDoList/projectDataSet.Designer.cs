...
namespace ToDoList {
    ...
    public partial class projectDataSet : global::System.Data.DataSet {
        ...
        public partial class tasksDataTable : global::System.Data.TypedTableBase<tasksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tasksRow AddtasksRow(string task, string description, string status, System.DateTime date) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tasksRow FindBytask(string task) {
...
namespace ToDoList.projectDataSetTableAdapters {
    ...
    public partial class tasksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `tasks` WHERE ((`task` = @p1) AND ((@p2 = 1 AND `description` IS NULL" +
                ") OR (`description` = @p3)) AND ((@p4 = 1 AND `status` IS NULL) OR (`status` = @" +
                "p5)) AND (`date` = @p6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `tasks` (`task`, `description`, `status`, `date`) VALUES (@p1, @p2, @" +
                "p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `tasks` SET `task` = @p1, `description` = @p2, `status` = @p3, `date` = @p" +
                "4 WHERE ((`task` = @p5) AND ((@p6 = 1 AND `description` IS NULL) OR (`descriptio" +
                "n` = @p7)) AND ((@p8 = 1 AND `status` IS NULL) OR (`status` = @p9)) AND (`date` " +
                "= @p10))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ToDoList.Properties.Settings.Default.projectConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `task`, `description`, `status`, `date` FROM `tasks`";
        ...
        public virtual int Delete(string p1, string p3, string p5, System.DateTime p6) {
            if ((p1 == null)) {
        ...
        public virtual int Update(string p1, string p2, string p3, System.DateTime p4, string p5, string p7, string p9, System.DateTime p10) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p2, string p3, System.DateTime p4, string p5, string p7, string p9, System.DateTime p10) {
